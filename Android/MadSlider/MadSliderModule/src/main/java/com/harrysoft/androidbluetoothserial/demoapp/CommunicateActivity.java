...
public class CommunicateActivity extends AppCompatActivity {
    ...
    private ElegantNumberButton buttonDelayBetweenPictures, buttonNumberOfPictures;

    private CommunicateViewModel viewModel;

    private int delayBetweenPictures = 0, numberOfPictures = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Button setup
        ElegantNumberButton buttonNumberOfPictures = (ElegantNumberButton) findViewById(R.id.numberOfPictures);
        ElegantNumberButton buttonDelayBetweenPictures = (ElegantNumberButton) findViewById(R.id.delayBetweenPictures);



        buttonDelayBetweenPictures.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            @Override
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
               delayBetweenPictures = newValue;
            }
        });

        buttonNumberOfPictures.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            @Override
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                numberOfPictures = newValue;
            }
        });
        ...
        sendButton.setOnClickListener(v -> viewModel.sendMessage((numberOfPictures + "," + delayBetweenPictures).toString()));
    }
