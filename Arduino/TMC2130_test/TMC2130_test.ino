...
void setup()
{
  ...
  //set TMC2130 config
  tmc_write(WRITE_FLAG|REG_GCONF,      0x00000100UL);
  tmc_write(WRITE_FLAG|0x70,      0x510F0);
  tmc_write(WRITE_FLAG|REG_IHOLD_IRUN, 0x00001010UL); //IHOLD=0x10, IRUN=0x10
  tmc_write(WRITE_FLAG|REG_CHOPCONF,   0x10044); //native 256 microsteps, MRES=0, TBL=1=24, TOFF=8
