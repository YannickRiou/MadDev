...
#define STRING_CONFIG_H_AUTHOR "(Mad3DPrinter, Marlin 2016)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mad 3D Printer"
...
#define TEMP_SENSOR_0 11 // was 13 ! on 07/01/18
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_INTEGRAL_DRIVE_MAX PID_MAX-1  //limit for the integral term
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.4   // Z offset: -below +above  [the nozzle] plus Below est grand (-10) plus ça rapproche la nozzle du bed ! 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,384,95}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 2, 22}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,999,5,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
