...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.0   // Z offset: -below +above  [the nozzle] plus Below est grand (-10) plus ça rapproche la nozzle du bed ! 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3190,90}  // default steps per unit for Ultimaker
