...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
 ...
 // Classic PID : 17/06/18
  #define  DEFAULT_bedKp 236.82
  #define  DEFAULT_bedKi 45.89
  #define  DEFAULT_bedKd 305.56
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 384, 95 }   // 104.4 with 32 micro steps enabled gives better results
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.45 // Z offset: -below +above  [the nozzle] (plus c'est grand plus la nozzle se rapproche du bed)
